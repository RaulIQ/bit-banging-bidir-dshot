...
uint32_t dshot_bb_buffer_1[DSHOT_BB_BUFFER_LENGTH * DSHOT_BB_FRAME_SECTIONS];
...
uint32_t dshot_bb_buffer_1_r[(int)(33 * BDSHOT_RESPONSE_BITRATE / 1000 + BDSHOT_RESPONSE_LENGTH + 1) * BDSHOT_RESPONSE_OVERSAMPLING];
